...
<div class="client-details bg-gray-100 p-6 ml-10 mr-10 mt-10 rounded-lg">
    ...
    <form method="post">
        <div class="grid grid-cols-2 gap-4">
            <h2 class="text-xl font-bold">Détails du client : <?php echo $client['NumeroClient']; ?></h2>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="mb-1">
                ...
                <input type="text" id="RaisonSociale" name="RaisonSociale" value="<?php echo $client['RaisonSociale']; ?>" placeholder="Exemple: SARL" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full px-1 py-1 mt-2 shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
        </div>
        <div class="grid grid-cols-2 gap-4">
            <div class="mb-1">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="mb-1">
                <label for="DureeDeplacement" class="block text-sm font-medium text-gray-700">Durée de déplacement:</label>
                <input type="text" id="DureeDeplacement" name="DureeDeplacement" value="<?php echo $client['DureeDeplacement']; ?>" placeholder="Temps en heure : 1" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full px-1 py-1 mt-2 shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div class="mb-1">
